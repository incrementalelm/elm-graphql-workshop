...
module ElmGithub.Union.CreatedPullRequestOrRestrictedContribution exposing (Fragments, fragments, maybeFragments)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo ElmGithub.Union.CreatedPullRequestOrRestrictedContribution

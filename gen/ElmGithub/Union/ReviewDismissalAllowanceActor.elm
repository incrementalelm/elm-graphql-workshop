...
module ElmGithub.Union.ReviewDismissalAllowanceActor exposing (Fragments, fragments, maybeFragments)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo ElmGithub.Union.ReviewDismissalAllowanceActor

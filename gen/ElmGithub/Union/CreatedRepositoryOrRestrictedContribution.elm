...
module ElmGithub.Union.CreatedRepositoryOrRestrictedContribution exposing (Fragments, fragments, maybeFragments)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo ElmGithub.Union.CreatedRepositoryOrRestrictedContribution

...
module ElmGithub.Union.CreatedIssueOrRestrictedContribution exposing (Fragments, fragments, maybeFragments)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo ElmGithub.Union.CreatedIssueOrRestrictedContribution

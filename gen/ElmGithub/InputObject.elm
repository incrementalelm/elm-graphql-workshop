...
encodeClosePullRequestInput input =
    Encode.maybeObject
        [ ( "pullRequestId", (ElmGithub.ScalarCodecs.codecs |> ElmGithub.Scalar.unwrapEncoder .codecId) input.pullRequestId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CommitContributionOrderRequiredFields =
    { field : ElmGithub.Enum.CommitContributionOrderField.CommitContributionOrderField
...
encodeCommitContributionOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum ElmGithub.Enum.CommitContributionOrderField.toString input.field |> Just ), ( "direction", Encode.enum ElmGithub.Enum.OrderDirection.toString input.direction |> Just ) ]


buildContributionOrder : ContributionOrderRequiredFields -> ContributionOrder
buildContributionOrder required =
    { field = required.field, direction = required.direction }


type alias ContributionOrderRequiredFields =
    { field : ElmGithub.Enum.ContributionOrderField.ContributionOrderField
    , direction : ElmGithub.Enum.OrderDirection.OrderDirection
    }
...
encodeContributionOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum ElmGithub.Enum.ContributionOrderField.toString input.field |> Just ), ( "direction", Encode.enum ElmGithub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
encodeCreatePullRequestInput input =
    Encode.maybeObject
        [ ( "repositoryId", (ElmGithub.ScalarCodecs.codecs |> ElmGithub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "baseRefName", Encode.string input.baseRefName |> Just ), ( "headRefName", Encode.string input.headRefName |> Just ), ( "title", Encode.string input.title |> Just ), ( "body", Encode.string |> Encode.optional input.body ), ( "maintainerCanModify", Encode.bool |> Encode.optional input.maintainerCanModify ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeDeletePullRequestReviewCommentInput input =
    Encode.maybeObject
        [ ( "id", (ElmGithub.ScalarCodecs.codecs |> ElmGithub.Scalar.unwrapEncoder .codecId) input.id |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
buildImportProjectInput required fillOptionals =
    ...
    in
    ImportProjectInput { ownerName = required.ownerName, name = required.name, body = optionals.body, public = optionals.public, columnImports = required.columnImports, clientMutationId = optionals.clientMutationId }
...
{-| Type alias for the `ImportProjectInput` attributes. Note that this type
needs to use the `ImportProjectInput` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/elm-graphql/issues/33>.
-}
type alias ImportProjectInputRaw =
    { ownerName : String
    , name : String
    , body : OptionalArgument String
    , public : OptionalArgument Bool
...
type ImportProjectInput
    = ImportProjectInput ImportProjectInputRaw
...
encodeImportProjectInput (ImportProjectInput input) =
    Encode.maybeObject
...
type alias MergePullRequestInputOptionalFields =
    ...
    , expectedHeadOid : OptionalArgument ElmGithub.ScalarCodecs.GitObjectID
    , clientMutationId : OptionalArgument String
    }
...
encodeMergePullRequestInput input =
    Encode.maybeObject
        [ ( "pullRequestId", (ElmGithub.ScalarCodecs.codecs |> ElmGithub.Scalar.unwrapEncoder .codecId) input.pullRequestId |> Just ), ( "commitHeadline", Encode.string |> Encode.optional input.commitHeadline ), ( "commitBody", Encode.string |> Encode.optional input.commitBody ), ( "expectedHeadOid", (ElmGithub.ScalarCodecs.codecs |> ElmGithub.Scalar.unwrapEncoder .codecGitObjectID) |> Encode.optional input.expectedHeadOid ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdatePullRequestInput input =
    Encode.maybeObject
        [ ( "pullRequestId", (ElmGithub.ScalarCodecs.codecs |> ElmGithub.Scalar.unwrapEncoder .codecId) input.pullRequestId |> Just ), ( "baseRefName", Encode.string |> Encode.optional input.baseRefName ), ( "title", Encode.string |> Encode.optional input.title ), ( "body", Encode.string |> Encode.optional input.body ), ( "maintainerCanModify", Encode.bool |> Encode.optional input.maintainerCanModify ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]

...
module ElmGithub.Interface.RegistryPackageOwner exposing (Fragments, fragments, id, maybeFragments)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo ElmGithub.Interface.RegistryPackageOwner
...
{-| -}
id : SelectionSet ElmGithub.ScalarCodecs.Id ElmGithub.Interface.RegistryPackageOwner
id =

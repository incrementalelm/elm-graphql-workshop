...
module ElmGithub.Interface.Reactable exposing (Fragments, ReactionsOptionalArguments, databaseId, fragments, id, maybeFragments, reactionGroups, reactions, viewerCanReact)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo ElmGithub.Interface.Reactable
...
-}
databaseId : SelectionSet (Maybe Int) ElmGithub.Interface.Reactable
databaseId =
    Object.selectionForField "(Maybe Int)" "databaseId" [] (Decode.int |> Decode.nullable)


{-| -}
id : SelectionSet ElmGithub.ScalarCodecs.Id ElmGithub.Interface.Reactable
id =
...
-}
reactionGroups : SelectionSet decodesTo ElmGithub.Object.ReactionGroup -> SelectionSet (Maybe (List decodesTo)) ElmGithub.Interface.Reactable
...
-}
reactions : (ReactionsOptionalArguments -> ReactionsOptionalArguments) -> SelectionSet decodesTo ElmGithub.Object.ReactionConnection -> SelectionSet decodesTo ElmGithub.Interface.Reactable
...
-}
viewerCanReact : SelectionSet Bool ElmGithub.Interface.Reactable
viewerCanReact =

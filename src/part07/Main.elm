...
Note that the {Code|currentWeather} end-point has changed since part07. It now has a required argument.
...
| List
    ...
    -> Fix the compiler error by supplying required arguments of the correct types."""
            }
        }

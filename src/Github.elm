...
simplest : SelectionSet String RootQuery
simplest =
    Query.viewer Github.Object.User.login


query : SelectionSet Response RootQuery
query =
    Query.user { login = "dillonkearns" } Github.Object.User.company


otherQuery : SelectionSet String RootQuery
otherQuery =
    Query.user { login = "dillonkearns" } Github.Object.User.company
